...
public interface RentalClient {
    ...
    ApiResponse<List<RentalDto>> getRentalsByHousingId(@PathVariable Long housingId, @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "20") int size,
